...
const def_pic = 'https://raw.githubusercontent.com/linfern-mou/linfern/refs/heads/main/tvbox/pic/4.jpg';
    ...
    if (tid.includes('#search#')) {
        ...
        return JSON.stringify({
            list: [{
                ...
                type_name: "直播列表",
                vod_pic: def_pic,
                vod_content: '有问题请联系阳尘',
                vod_play_from: vod_play_from,
                vod_play_url: vod_play_url,
                vod_director: '阳尘',
                vod_remarks: `有问题请联系阳尘`,
            }]
        });
    }
    let html;
